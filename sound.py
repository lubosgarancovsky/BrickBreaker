...
class Sound:
    def __init__(self):
        ...
        self.bounce_pad = pygame.mixer.Sound("Assets/bounce2.wav")
        self.bounce_wall = pygame.mixer.Sound("Assets/bounce3.wav")
        self.lost_round = pygame.mixer.Sound("Assets/lost.wav")
    ...
    def play_game_song(self):
        self.game_song.load("Assets/game_song.wav")
